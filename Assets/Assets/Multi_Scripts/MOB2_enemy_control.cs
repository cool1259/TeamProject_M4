...
public class MOB2_enemy_control : MonoBehaviour
{
  ...
  //  private AudioSource SOUND;
    ...
    void Update()
    {
        ...
        //사격
        if (anim.GetCurrentAnimatorStateInfo(0).IsName("Attack") && start_attack && GameObject.FindWithTag("Player") != null && !fighting)
        {
...
*/
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("ENEMY_DELETE"))
        {
